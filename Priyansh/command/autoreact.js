...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
  ...
  if(react.includes("Pakistan") || react.includes("Pakistani") || react.includes("pak") || react.includes("Pk")) {
      var flag = {
        body: ""
      }
